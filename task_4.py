...
number_list = int(input("Введите место в списке поступающих:"))
if number_list <= 10:
    print("Поздравляем, Вы поступили!")
    ball_list = int(input("Введите количество баллов за экзамены:"))
    if ball_list >= 290:
        print("Бонусом Вам будет начисляться стипендия")
    else:
        print("Но Вам не хватило баллов для стипендии")
else:
    print("Вам не хватило рейтинга для поступления!")