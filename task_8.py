...
if square1 >= 100 and price1 <= 10000000:
    print("Кваритира подходит!")
elif square1 >= 80 and price1 <= 7000000:
    print("Кваритира подходит!")
else:
...
if square2 >= 100 and price2 <= 10000000:
    print("Кваритира подходит!")
else:
    print("Квартира не подходит!")
...
print("Второй вариант")
price3 = int(input("Введите стоимость квартиры: "))
square3 = int(input("Введите площадь квартиры: "))
if square3 >= 80 and price3 <= 7000000:
    print("Кваритира подходит!")
else:
    print("Квартира не подходит!")